...
.economic-comparison td:nth-child(1) { width: 17%; }
.economic-comparison th:nth-child(2),
.economic-comparison td:nth-child(2) { width: 13%; text-align: right; }
.economic-comparison th:nth-child(3),
.economic-comparison td:nth-child(3) { width: 18%; text-align: right; }
.economic-comparison th:nth-child(4),
.economic-comparison td:nth-child(4) { width: 19%; text-align: right; }
.economic-comparison th:nth-child(5),
.economic-comparison td:nth-child(5) { width: 33%; text-align: left; }
